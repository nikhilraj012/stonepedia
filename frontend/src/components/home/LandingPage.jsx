    ...
    <div className="relative h-screen lg:h-[80vh]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full">
        ...
        <div className="w-full flex flex-col gap-3 lg:gap-5 items-center px-5">
          ...
          <a
            href="#"
            className="relative inline-flex items-center justify-center p-1 md:px-8 md:py-2 overflow-hidden font-mono font-medium tracking-tighter text-white border-2 border-[#FBAD30] rounded-lg group"
          >
